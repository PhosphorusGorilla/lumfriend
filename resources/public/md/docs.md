...
Two middleware functions by default which are are located in the `friendtrial.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `friendtrial.handler` namespace to manage the enabled middleware.
